...
def _get_device(dev: str) -> str:
    """Determine device (cpu/cuda) based on availability."""
    if dev == "auto":
        try:
...
@dataclass
class Config:
    """Configuration for Nash Q-Learning."""
    ...
    log_file: str = "Nash-QL/logs/nash_ql.log"
    log_to_console: bool = True

    # Inference
    inference_model_path: str = "Nash-QL/checkpoints/best.pt"
    episodes: int = 5
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Convert config to dictionary (excludes wandb_key for logging)."""
        return {
