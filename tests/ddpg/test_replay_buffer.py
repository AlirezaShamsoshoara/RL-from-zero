"""DDPG replay buffer tests.

Examples:
    >>> # Run with pytest
    >>> # python -m pytest tests/ddpg/test_replay_buffer.py
    >>> # Run with unittest
    >>> # python -m unittest tests.ddpg.test_replay_buffer
"""
...
from DDPG.ddpg.replay_buffer import ReplayBuffer
...
class TestReplayBuffer(unittest.TestCase):
    ...
    def test_overwrites_oldest_when_full(self) -> None:
        ...
        # ptr wraps back around: (capacity + 2) % capacity = 2
    ...
    def test_cannot_sample_when_empty(self) -> None:
